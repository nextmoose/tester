		    ...
		    lib =
			  ...
			  result =
			    let
			      ...
			      in _utils.visit { lambda = lambda ; set = set ; undefined = undefined ; } ( builtins.trace ( builtins.concatStringsSep "," ( builtins.attrNames ( builtins.getAttr system test.lib ) ) test ) ;
